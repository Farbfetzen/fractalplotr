#
# # TODO:
# # - Find a better solution for the color palette argument. less verbose for the
# #   user.
# # - Look at zlim argument of image function. could be usefull for color
# #   normalization.
...
# # - Change the default arguments. That many NULL does not look right.
#
#
# nice_gradients <- list(
...
#       height = height)
#   par(mar = c(0, 0, 0, 0))
#   image(fractal_set, col = color_palette, axes = FALSE, ann = FALSE,
#         useRaster = TRUE)
#   dev.off()
# }
#
...
#   write.table(fractal_set, file = file_name, sep = ",", col.names = FALSE,
#               row.names = FALSE)
# }
#
#
# load_from_file <- function(file_name) {
#   as.matrix(read.table(file_name, sep = ","))
# }
#
#
...
#
#
# fractal_jm <- function(fractal_type, width, height, re_lim = NULL,
#                        im_lim = NULL, center = NULL, re_width = NULL,
#                        im_height = NULL, max_iterations = 128,
#                        julia_constant = NULL, adjust = "none") {
